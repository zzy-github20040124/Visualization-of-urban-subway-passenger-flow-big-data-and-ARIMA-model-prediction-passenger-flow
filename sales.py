...
fname = "D:\AI\salesPredict-master\salesPredict-master\data\site_date\\" + input("请输入想要预测的站点信息") +".xls"
fname = "D:\AI\salesPredict-master\salesPredict-master\data\sales.xls"
def loadData(fname):
    '''
    导入数据
    :return:
...
if __name__ == '__main__':
    predictSales(fname,6,isVisiable=True)